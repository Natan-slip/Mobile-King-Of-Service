package br.com.kingofservice.dao
...
import br.com.kingofservice.utils.converterBitmapParaBase64
import br.com.kingofservice.utils.converterBitmapParaByteArray
import br.com.kingofservice.utils.converterByteArrayParaBitmap
import br.com.kingofservice.utils.obterDiferencaEntreDatasEmAnos
...
class UsuarioDao(val context: Context, val usuario: Usuario?) {
    ...
    public fun gravar() {
        ...
        dados.put("foto", converterBitmapParaByteArray(usuario.foto as Bitmap?))
